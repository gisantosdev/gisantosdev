# GISELLE SANTOS ANDRADE
### Desarrollo de Aplicaciones Multiplataforma (DAM) | Java Backend Developer

---

## Perfil Profesional
Estudiante de último año del Grado Superior en **Desarrollo de Aplicaciones Multiplataforma (DAM)**. Especializada en el ecosistema **Java**, con un enfoque sólido en el desarrollo backend, arquitectura de aplicaciones y principios de Clean Code. En constante formación técnica, iniciando actualmente especialización en **Java EE (JEE)** y **Spring Framework**.
...
![Java EE](https://img.shields.io/badge/Java_EE-0073B7?style=for-the-badge&logo=java&logoColor=white)
...
### IkasBalora
*Sistema integral desarrollado como proyecto principal en el grado DAM. Implementa una arquitectura de servicios desacoplados para la gestión y evaluación educativa.*
...
* **Español:** Competencia bilingüe (Segunda lengua).
* **Inglés:** Nivel B2 (Certificación oficial).
